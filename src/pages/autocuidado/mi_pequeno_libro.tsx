...
const Historia = () => {
  return (
    <AutocuidadoLayout title="Mi Pequeño Libro de Métodos de Afrontamiento">
      <TabList>
        <Tab title="Mis detonantes" read="3 minutos">
          <p className="">
            Un "detonante" es algo que te recuerda una experiencia o emoción que
            es dolorosa, aterradora, peligrosa o perturbadora. Un detonante
            puede ser un olor, un sabor, una sensación, una palabra o incluso
            ver algo relacionado con un evento traumático.
          </p>
          <p className="">
            En ocasiones, saber cuáles son nuestros detonantes puede ayudarnos.
          ...
          <p className="">
            ...
            volvernos incapaces de distinguir entre el recuerdo y el presente.
          </p>
          <p className="">
          ...
          <p className="">
            ...
            posible que sientas que el ataque o un aspecto del abuso que has
            experimentado en realidad está sucediendo nuevamente mientras
          ...
          <p className="">
            ...
            emocional abrumadora. Las sobrevivientes de violencia sexual o
            doméstica pueden usar esto como una salida para sentimientos
            difíciles o dolorosos. Es posible que estés tratando de adormecer el
            dolor, experimentar algo de alivio o tratar de recuperar una
            sensación de control.
          </p>
          <p className="">
            Sin embargo, la autolesión es una estrategia de afrontamiento
          ...
          <p className="">
            ...
            estos pueden ser agotadores, dolorosos y muy confusos. Es posible
            que morir no sea algo que realmente quieras hacer. Pero podría ser
        ...
        <Tab title="¿Qué es Disociación?" read="3 minutos">
          <p className="">
            Disociación es cuando te separas de la realidad. Puedes imaginarte
            la disociación como un espectro, que va desde experiencias como
            soñar despierta hasta una disociación crónica y compleja, que puede
            hacer que la vida cotidiana sea muy difícil.
          </p>
          <p className="">
            Entonces, ¿por qué podríamos disociarnos? La disociación es un
            mecanismo de defensa que el cerebro usa para lidiar con algún
          ...
          <p className="">
            ...
            los sentimientos relacionados al control. Por supuesto, esto puede
            llevar a algunas de nosotras a desarrollar trastornos alimenticios,
            cuando cambiamos nuestros hábitos alimenticios para tener un sentido
            de control, para hacer frente al trauma y los sentimientos. Si bien
          ...
          <p className="">
            ...
            traumático. Estas sustancias pueden hacernos sentir adormecidas y
            dejar que algo del dolor escape temporalmente. Cuando nos sentimos
            deprimidas, puede ser tentador recurrir a soluciones rápidas que
          ...
          <p className="">
            ...
            abusador les hace sentir que fue su culpa.
          </p>
          <p className="">
          ...
          <p className="">
            ...
            con nadie. Podrías pensar que te juzgarán, le dirán a otras personas
            o no te creerán.
          </p>
          <p className="">
          ...
          <p className="">
            ...
            nuestro aspecto, nuestra ropa y nuestra personalidad. Puede parecer
            que ese abusador nos ha destruido y creemos que nunca volveremos a
            sentirnos seguras ni felices.
          </p>
          <p className="">
